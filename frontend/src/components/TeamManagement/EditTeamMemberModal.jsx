...
const EditTeamMemberModal = ({ showModal, setShowModal, member, roles, onSubmit }) => {
    ...
    >
      <div className="bg-white rounded-lg w-full max-w-md p-6">
        <div className="flex justify-between items-center border-b pb-4 mb-4">
          <h5 className="text-xl font-semibold text-gray-800">Edit Team Member</h5>
          <button
